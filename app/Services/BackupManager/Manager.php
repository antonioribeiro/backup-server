...
use BackupManager\Manager as BackupManagerManager;

class Manager extends BackupManagerManager
{
     ...
     * @return Procedures\RestoreProcedure
     */
    public function makeRename() {
        return new Procedures\RenameProcedure(
            $this->filesystems
        );
    }
